...
class NewsAndEvents(models.Model):
    title = models.CharField('العنوان',max_length=200, null=True)
    summary = models.TextField('التفاصيل',max_length=200, blank=True, null=True)
    posted_as = models.CharField('نوع المنشور',choices=POST, max_length=10)
